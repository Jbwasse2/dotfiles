...
__conda_setup="$(CONDA_REPORT_ERRORS=false '/home/justin/anaconda3/bin/conda' shell.bash hook 2> /dev/null)"
if [ $? -eq 0 ]; then
    \eval "$__conda_setup"
else
...
unset __conda_setup
# <<< conda init <<<
export PATH=/usr/bin/pycharm-community-2018.2.4/bin/:$PATH
...
#Short cuts
alias r=ranger
alias corn='cd /home/justin/Documents/playground/PWC/PWC-Net/PyTorch'
alias weasel='cd /home/justin/Documents/self-assembly'
alias lock='systemctl suspend'
alias class='cd /home/justin/Documents/class/2019sp'
